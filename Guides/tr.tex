...
Although many of the ideas behind cryptocurrencies date back around twenty years (e.g., cryptographic e-cash~\cite{chaum-ecash} and smart contract~\cite{szabo1997formalizing}), a recent surge of interest in this technology has been incited by the success of Bitcoin~\cite{bitcoin}. For a comprehensive survey on Bitcoin and other cryptocurrencies, see ~\cite{researchperspectives,bittertobetter}.
